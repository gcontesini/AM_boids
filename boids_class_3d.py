...
# # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  def __init__(self):
    ...
    self.position_ary = (rand.random(3)-0.5)*10
    self.velocity_ary = (rand.random(3)-0.5)
    self.acceleration_ary = (rand.random(3)-0.5)
    self.max_velocity_float = 0.5
    self.max_acceleration_float = 1
...
# # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  def boids_rules(self, boid_set_):
    ...
    alignment_weight_float = 0.55
    cohesion_weight_float = 0.99
    separation_weight_float = 0.75

    max_interaction_radius_float = 2.0
    number_interactions_int = 0
    
    final_alignment_ary = np.zeros(3)
    final_cohesion_ary = np.zeros(3)
    final_separation_ary =  np.zeros(3)

    final_interaction_ary = np.zeros(3)
...
# # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  def boundary_condition( self, lattice_size_int_ ):
    ...
    if( self.position_ary[2] > pigsty_size_int_ ):

      self.position_ary[2] = pigsty_size_int_ - self.position_ary[2]  

    elif( self.position_ary[2] < 0):
...
# # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  def update(self, lattice_size_int_, boids_rules_ary_=np.zeros(3) ):
    ...
    self.acceleration_ary = np.zeros(3)  